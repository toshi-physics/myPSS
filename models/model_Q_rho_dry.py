...
def main():
    ...
    initParser = argparse.ArgumentParser(description='Run Model_Q_rho_dry')
    ...
    savedir     = "data/model_Q_rho_dry/gamma0_{:.2f}_rhoseed_{:.2f}_pi_{:.3f}/run_{}/".format(Gamma0, rho_seed, Pii, run)
